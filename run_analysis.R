...
subject <- read.table(file = "./UCI HAR Dataset/test/subject_test.txt", header = FALSE, sep = "")
subject2 <- read.table(file = "./UCI HAR Dataset/train/subject_train.txt", header = FALSE, sep = "")
